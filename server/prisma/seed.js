...
async function seed() {
  ...
  if (existingDesc === 0 || forceReset) {
    ...
    const customDesc = {
      "Bahasa Indonesia": {
        "7": { A: { title: "Analysing", descriptors: ["identifies and explains the content, context, language, structure, technique and style of texts", "justifies opinions and ideas with examples and explanations"] }, B: { title: "Organizing", descriptors: ["makes use of organizational structures that serve the context and intention", "organizes opinions and ideas with coherence and logic"] }, C: { title: "Producing text", descriptors: ["produces texts that demonstrate personal engagement with the creative process"] }, D: { title: "Using language", descriptors: ["uses a range of appropriate vocabulary, sentence structures and forms of expression", "writes and speaks in a register and style that serve the context and intention"] } },
        "8": { A: { title: "Analysing", descriptors: ["identifies and explains the content, context, language, structure, technique and style of texts", "justifies opinions and ideas with examples and explanations"] }, B: { title: "Organizing", descriptors: ["organizes opinions and ideas with coherence and logic", "uses referencing and formatting tools appropriately"] }, C: { title: "Producing text", descriptors: ["produces texts that demonstrate personal engagement with the creative process"] }, D: { title: "Using language", descriptors: ["uses a range of appropriate vocabulary, sentence structures and forms of expression"] } },
        "9": { A: { title: "Analysing", descriptors: ["provides perceptive identification and explanation of the content, context, language, structure, technique and style", "provides perceptive analysis of the effects of the creator's choices on an audience"] }, B: { title: "Organizing", descriptors: ["makes sophisticated use of organizational structures", "organizes opinions and ideas with a high degree of coherence and logic"] }, C: { title: "Producing text", descriptors: ["produces texts that demonstrate sophisticated personal engagement with the creative process"] }, D: { title: "Using language", descriptors: ["uses a sophisticated range of appropriate vocabulary and forms of expression"] } },
      },
      "English": {
        "7": { A: { title: "Listening", descriptors: ["identifies explicit and some implicit information"] }, B: { title: "Reading", descriptors: ["identifies explicit and some implicit information"] }, C: { title: "Speaking", descriptors: ["communicates with some clarity and coherence"] }, D: { title: "Writing", descriptors: ["writes with some clarity and coherence"] } },
        "8": { A: { title: "Listening", descriptors: ["identifies explicit and some implicit information"] }, B: { title: "Reading", descriptors: ["makes some connections between texts and contexts"] }, C: { title: "Speaking", descriptors: ["uses some range of vocabulary and grammatical structures"] }, D: { title: "Writing", descriptors: ["uses some range of vocabulary and grammatical structures"] } },
        "9": { A: { title: "Listening", descriptors: ["identifies explicit and implicit information in detail"] }, B: { title: "Reading", descriptors: ["analyses explicit and implicit information in depth"] }, C: { title: "Speaking", descriptors: ["communicates with clarity, coherence and sophistication"] }, D: { title: "Writing", descriptors: ["writes with clarity, coherence and sophistication"] } },
      },
    };
      ...
      for (const [gradeLevel, criteriaMap] of Object.entries(desc)) {
        for (const [criteria, data] of Object.entries(criteriaMap)) {
          await prisma.criteriaDescriptor.create({
            data: { subjectId: subject.id, gradeLevel, criteria, title: data.title, descriptors: data.descriptors },
          });
        }
      }
    }
