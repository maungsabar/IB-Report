...
app.use('/api/students', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), studentsRouter);
app.use('/api/teachers', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), teachersRouter);
app.use('/api/classes', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), classesRouter);
app.use('/api/subjects', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), subjectsRouter);
app.use('/api/grades', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), gradesRouter);
app.use('/api/attendance', authenticate, authorize('admin', 'coordinator', 'homeroom'), attendanceRouter);
app.use('/api/homeroom-comments', authenticate, authorize('admin', 'coordinator', 'homeroom'), homeroomCommentsRouter);
app.use('/api/academic-years', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), academicYearsRouter);
app.use('/api/school-profile', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), schoolProfileRouter);
app.use('/api/users', authenticate, authorize('admin'), usersRouter);
app.use('/api/alumni', authenticate, authorize('admin'), alumniRouter);
app.use('/api/criteria-descriptors', authenticate, authorize('admin', 'coordinator', 'homeroom', 'subject'), criteriaDescriptorsRouter);
app.use('/api/learner-profiles', authenticate, authorize('admin', 'coordinator', 'subject', 'homeroom'), learnerProfilesRouter);
