          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-primary-200">{schoolProfile?.name || 'IB-MYP School'}</span>
              </div>
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
                Selamat Datang, {currentUser?.name?.split(',')[0] || 'Guru'}
              </h1>
            ...
            <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3">
              ...
              <div>
                <p className="text-sm font-semibold">Tahun Ajaran {activeYearStr}</p>
                <p className="text-xs text-primary-200">{semesterLabel}</p>
              </div>
            </div>
          </div>
        </div>
                ...
                {myStudents.map((student, idx) => (
                  <tr key={student.id} className="hover:bg-warm-50/50 transition-colors">
                    ...
                    <td className="px-4 py-2">
                      ...
                      <p className="text-[11px] text-gray-400">NIS: {student.nis}</p>
                    </td>
